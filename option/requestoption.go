...
// RequestOption is an option for the requests made by the miru API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/miru-server-go#readme-requestoptions
...
// WithHost returns a RequestOption that sets the client setting "host".
func WithHost(value string) RequestOption {
...
// WithVersion returns a RequestOption that sets the client setting "version".
func WithVersion(value string) RequestOption {
	return requestconfig.PreRequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.Version = value
		return nil
	})
